...
@export_range(10.0, 10000.0) var range_units: float = 1000.0
@export_range(0.1, 1000.0) var damage: float = 5.0
@export_range(1.0, 10000.0) var launch_speed: float = 200.0
@export_range(1.0, 1000.0) var gravity: float = 30.0
