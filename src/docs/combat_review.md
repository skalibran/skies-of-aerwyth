...
| [CombatSpawner](../../scripts/tools/combat_spawner.gd) | Debug-only population driver: two ships per faction per simulation second, separately capped at 100, with bounded clearance attempts around the anchor. No defeated-side shutdown or progression is implied. |
