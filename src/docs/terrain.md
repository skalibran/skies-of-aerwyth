...
Each patch samples a 32 × 32 display grid. At the current 5-unit resolution, the smallest patches span 160 units; root patches span 1280 units, with 320/640-unit patches between them. For 10-unit voxels the minimum is 320 units and roots remain 1280; for 1-unit voxels the minimum is 32 and roots are 1024. **Distant meshes are approximations**, while source terrain height queries retain the selected voxel resolution.
