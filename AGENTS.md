...
- Journey's shared depth fog builds linearly from the camera, restoring nearby atmospheric haze and fully blending scenery into the sky by 28000 meters to conceal the 30000-meter camera cutoff. Terrain, water, ships, and islands share this fog profile. See [horizon haze](src/docs/terrain.md#horizon-haze).
