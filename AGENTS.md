...
- `scripts/tools/profile_landscape.gd` measures isolated landscape rendering/streaming and compares 10/50/100-meter cells. See the [landscape measurements](src/docs/terrain_performance.md). Terrain collision is not implemented.
